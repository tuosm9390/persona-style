...
const EXAMPLES_KO: ExampleCase[] = [
  {
    ...
    result: {
      summary: {
        ...
        description:
          "당신은 따뜻한 봄 햇살처럼 밝고 생기 넘치는 에너지를 가지고 있습니다. 사랑스럽고 여성스러운 스타일이 당신의 매력을 극대화합니다.",
      },
      analysis: {
      ...
      fashion: {
        overview:
          "파스텔 톤과 부드러운 소재, 플로럴 패턴이 잘 어울립니다. 과한 디테일보다는 은은한 포인트가 좋습니다.",
  ...
  },
  {
    ...
    result: {
      summary: {
        ...
        description:
          "부드럽고 시원한 여름의 이미지입니다. 차분하면서도 세련된 분위기가 당신의 트레이드마크입니다.",
      },
      analysis: {
      ...
      fashion: {
        overview:
          "채도가 낮고 명도가 높은 쿨톤 컬러가 잘 어울립니다. 심플하고 깔끔한 라인의 옷을 추천합니다.",
  ...
  },
  {
    ...
    result: {
      summary: {
        ...
        description:
          "깊이 있고 그윽한 가을의 정취를 닮았습니다. 자연스러우면서도 고급스러운 분위기를 자아냅니다.",
      },
      analysis: {
      ...
      fashion: {
        overview:
          "톤 다운된 따뜻한 컬러와 질감이 돋보이는 소재가 잘 어울립니다. 레이어드 룩을 시도해보세요.",
      ...
      beauty: {
        overview:
          "매트하고 보송한 피부 표현과 깊이 있는 음영 메이크업이 포인트입니다.",
        foundation: "매트 파운데이션",
  ...
  },
  {
    ...
    result: {
      summary: {
        ...
        description:
          "차가운 겨울 바람처럼 강렬하고 선명한 인상을 줍니다. 모던하고 시크한 스타일이 누구보다 잘 어울립니다.",
      },
      analysis: {
      ...
      fashion: {
        overview:
          "블랙&화이트의 대비가 강한 스타일이나 비비드한 원색 포인트가 잘 어울립니다. 깔끔하고 딱 떨어지는 핏을 추천합니다.",
      ...
      beauty: {
        overview:
          "잡티 없는 깨끗한 피부 표현과 립 포인트 메이크업이 베스트입니다.",
...
const EXAMPLES_EN: ExampleCase[] = [
  {
    ...
    result: {
      summary: {
        ...
        description:
          "You have bright and lively energy like warm spring sunshine. Lovely and feminine style maximizes your charm.",
      },
      analysis: {
      ...
      fashion: {
        overview:
          "Pastel tones, soft fabrics, and floral patterns suit you well. Subtle points are better than excessive details.",
      ...
      beauty: {
        overview:
          "Transparent and clear skin expression and lively lip color are key.",
  ...
  },
  {
    ...
    result: {
      summary: {
        ...
        description:
          "Soft and cool image of summer. A calm yet sophisticated atmosphere is your trademark.",
      },
      analysis: {
      ...
      fashion: {
        overview:
          "Cool tones with low saturation and high brightness suit you well. Simple and clean lines are recommended.",
      ...
      beauty: {
        overview:
          "Clean and matte skin expression and cool pink points are good.",
  ...
  },
  {
    ...
    result: {
      summary: {
        ...
        description:
          "Resembles the deep and rich sentiment of autumn. Creates a natural yet luxurious atmosphere.",
      },
      analysis: {
      ...
      fashion: {
        overview:
          "Toned-down warm colors and textured fabrics suit you well. Try a layered look.",
      ...
      beauty: {
        overview:
          "Matte and soft skin expression and deep shading makeup are points.",
  ...
  },
  {
    ...
    result: {
      summary: {
        ...
        description:
          "Gives a strong and vivid impression like cold winter wind. Modern and chic style suits you better than anyone.",
      },
      analysis: {
      ...
      fashion: {
        overview:
          "Strong contrast of black & white or vivid primary color points suit well. Clean and perfectly fitting fit is recommended.",
